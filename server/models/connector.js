...
module.exports = {
        ...
        pool.getConnection(function (err, connection) {
          if (err) throw err; // not connected!
            ...
            connection.query(sql, values, function (error, results, fields) {
              ...
              if (results.length <= 0) {
                resultsNotFound["errorMessage"] = "Parking not found.";
                return res.send(resultsNotFound);
              }
  ...
  Simulations : function(address)
  {
    this.Simulations1(address);
    this.Simulations2(address);

    if(simoulation1Result["result"] > simoulation2Result["result"] )
         //Simulation 1 is the best
         resultsFound["data"] = simoulation1Result;
    

    else //Simulation 2 is the best
       resultsFound["data"] = simoulation2Result;
  
  },

  Simulations1 : function(address)
  {
